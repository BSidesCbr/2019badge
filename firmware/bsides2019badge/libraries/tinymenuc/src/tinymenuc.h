...
#define TMNU_API
typedef void(TMNU_API *TmnuMenuItemStringFn)(void *,uint32_t,char *, uint32_t);
typedef void(TMNU_API *TmnuMenuItemOnSelectFn)(void *,uint32_t);
typedef void(TMNU_API *TmnuCalcStringViewFn)(void *, const char *, uint32_t *, uint32_t *);
typedef void(TMNU_API *TmnuDrawStringFn)(void *, uint32_t, uint32_t, const char *, TMNU_BOOL);
...
TMNU_BOOL tmnu_init(void *data, uint32_t size);
